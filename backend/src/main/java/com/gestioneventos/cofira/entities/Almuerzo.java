...
public class Almuerzo {
    ...
    @ElementCollection
    @CollectionTable(name = "almuerzo_ingredientes", joinColumns = @JoinColumn(name = "almuerzo_id"))
    @Column(name = "ingrediente", columnDefinition = "TEXT")
    private List<String> ingredientesJson;

    @ElementCollection
    @CollectionTable(name = "almuerzo_pasos", joinColumns = @JoinColumn(name = "almuerzo_id"))
